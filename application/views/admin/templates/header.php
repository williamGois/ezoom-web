...
<div id="wrapper">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?= base_url("admin") ?>">Ezoom Cursos <sup><small><span class="label label-danger">v1.0</span></small></sup> </a>
		</div>
		...
		<nav class="collapse navbar-collapse navbar-ex1-collapse">
			...
			<ul class="nav navbar-nav side-nav">
				...
				<li><a href="<?= base_url("admin/curso") ?>"><i class="glyphicon glyphicon-picture"></i> Cursos</a></li>
			</ul>
